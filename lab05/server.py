...
"""
# Register files in "test_inputs" recursively
for root, dirnames, filenames in os.walk('test_inputs'):
  for f in filenames:
    f = root + '/' + f
    print("ADDING : ", f, " : ", os.path.relpath(f, 'test_inputs'))
    RPCServerHandler.register_file(f, os.path.relpath(f, 'test_inputs'))
# Point '' to index.html
"""
