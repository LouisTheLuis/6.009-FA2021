...
def test_tiny_1():
    actor1 = 1532
    actor2 = 2876
    assert lab.acted_together(db_tiny, actor1, actor2) == True
...
def test_actors_with_bacon_number_0():
    result = {4724}
    assert lab.actors_with_bacon_number(db_tiny, 0) == result
    
def test_actors_with_bacon_number_1():
    result = {2876, 1532}
    assert lab.actors_with_bacon_number(db_tiny, 1) == result

def test_actors_with_bacon_number_2():
    result = {1640}
    assert lab.actors_with_bacon_number(db_tiny, 2) == result
    
def test_actors_with_bacon_number_3():
    result = set()
    assert lab.actors_with_bacon_number(db_tiny, 3) == result
...
def test_actor_to_actor_new():
    expected = [4724, 2876, 1640]
    result = lab.actor_to_actor_path(db_tiny, 4724, 1640)
